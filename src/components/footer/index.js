...
import { socialprofils, logoUrl, contactConfig } from "../../content_option";
      ...
      <div class="pg-footer">
        <footer class="footer">
          <div class="footer-content">
            ...
            <div class="footer-content-column">
              <div class="footer-menu">
                <h2 class="footer-menu-name"> Sites</h2>
                <ul id="menu-company" class="footer-menu-list">
                  <li class="menu-item menu-item-type-post_type menu-item-object-page">
                    <a href="#">Ram mandir</a>
                  </li>
                  <li class="menu-item menu-item-type-taxonomy menu-item-object-category">
                    <a href="#">Bhairab mandir</a>
                  </li>
                  <li class="menu-item menu-item-type-post_type menu-item-object-page">
                    <a href="#">See all sites {">>"}</a>
                  </li>
                </ul>
              </div>
              <div class="footer-menu">
            ...
            <div class="footer-content-column">
              <div class="footer-menu">
                <h2 class="footer-menu-name"> Explore</h2>
            ...
            <div class="footer-content-column">
              ...
              <div class="footer-call-to-action">
                <h2 class="footer-call-to-action-title"> Mail Us</h2>
                <p class="footer-call-to-action-link-wrapper">
                  {" "}
                  <a
                    class="footer-call-to-action-link"
              ...
              <div className="social-links pt-4">
                <a href={socialprofils.facebook} target="_blank">
                  <span class="icon mt-5 has-text-white mx-1">
